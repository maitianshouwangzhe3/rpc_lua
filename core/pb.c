...
LUALIB_API int luaopen_rpc_pb_io(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_rpc_pb_conv(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_rpc_pb_buffer(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_rpc_pb_slice(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_rpc_pb(lua_State *L) {
    luaL_Reg libs[] = {
...
LUALIB_API int luaopen_rpc_pb_unsafe(lua_State *L) {
    luaL_Reg libs[] = {
